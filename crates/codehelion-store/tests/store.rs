...
fn sample_summary() -> SummaryRow {
    SummaryRow {
        ...
        guardrails: Some(codehelion_store::snapshot::GuardrailsRow {
            ...
            posting_cap: 40,
            pair_budget: 50,
            near_miss_delta_bits: Some(0.05_f64.to_bits()),
            near_miss_cap: Some(54),
            verification_budget: Some(55),
            max_alignment_cells: Some(56),
            sibling_candidate_budget: Some(51),
            sibling_per_group_cap: Some(52),
            sibling_total_cap: Some(53),
            signature_sibling_candidate_budget: Some(57),
            signature_sibling_per_group_cap: Some(58),
            signature_sibling_total_cap: Some(59),
            signature_sibling_max_units_per_signature: Some(61),
            max_component: Some(60),
        }),
        excluded_skipped: 5,
        folded_runs: 6,
        subsumed_runs: 7,
        split_components: 8,
        common_signatures_skipped: 9,
        largest_skipped_signature_units: 137,
