...
/// What a report does with a clone group whose every member matches one
/// boilerplate shape.
///
/// The classification itself is always recorded; this only decides how the
/// group is presented.
#[derive(Debug, Clone, Copy, PartialEq, Eq, Default, Serialize, Deserialize)]
#[serde(rename_all = "kebab-case")]
pub enum BoilerplateAction {
...
impl BoilerplatePolicy {
    ...
    #[must_use]
    pub const fn action(&self, category: Boilerplate) -> BoilerplateAction {
        match category {
