...
fn mark_narrower_cuts(groups: &mut [Group]) {
...
mod tests {
    use super::{
        CLONE_ID_SCOPE, Group, Member, Priority, SummaryRow, Suppression, SuppressionKind,
        UnusedRule, mark_narrower_cuts, restored,
    };
